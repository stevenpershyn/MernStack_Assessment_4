...
export default class User{} //default export, only one default export is allowed in one file
...
//when we do named import we should do it within {}
import {userAge, userAddress}  from "./user" //named import

//in case of duplicate imports we can alias while importing
import {userAge as personAge}  from "./person" //named import


//named and default can be imported togather

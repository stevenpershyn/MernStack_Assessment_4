...
var user = { 
                ...
                getDetails : function () {
                    ...
                    // var _this = this; //copying into other object and the using it inside delayed function
...
user.getDetails() //getDetails is executed over user so context/scope is user, but it changes inside setTimeout
